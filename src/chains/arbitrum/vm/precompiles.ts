...
export const precompiles: (Precompile | Predeploy)[] = [
  ...
  },
  {
    ...
    description: "Initiates Arbitrum to Ethereum ERC20 transfers, which are forwarded to the token's L2 Gateway to communicate with its corresponding L1 Gateway.",
    deprecated: false,
    references: ['https://developer.arbitrum.io/for-devs/useful-addresses'],
  },
  {
    ...
    description: "Allows to transfer of custom tokens from Arbitrum to Ethereum, which are forwarded to the L2 Gateway to communicate with its corresponding L1 Gateway.",
    deprecated: false,
    references: ['https://developer.arbitrum.io/for-devs/useful-addresses'],
  },
  {
    ...
    description: "Handles Arbitrum to Ethereum transfers of WETH by unwrapping the Ether and re-wrapping it on Ethereum, ensuring that all WETH tokens are always fully collateralized on the layer it's transferred to.",
    deprecated: false,
    references: ['https://developer.arbitrum.io/for-devs/useful-addresses'],
  },
  {
    ...
    name: 'L2 Weth',
    description: 'Wrapped Ether contract on Arbitrum, which is an ERC-20 token that represents 1 Ether.',
    deprecated: false,
    references: ['https://developer.arbitrum.io/for-devs/useful-addresses'],
  },
  {
  ...
  },
  {
    ...
    name: 'L2 Dai Gateway',
    description: 'Handles minting and burning of Arbitrum DAI based on messages from L1 Dai Gateway or withdrawals.',
    deprecated: false,
    references: ['https://developer.arbitrum.io/for-devs/useful-addresses'],
  },
  {
    ...
    description: 'Handles minting and burning of Arbitrum Livepeer based on messages from L1 Livepeer Gateway or withdrawals.',
    deprecated: false,
    references: ['https://developer.arbitrum.io/for-devs/useful-addresses'],
  },
  {
    ...
    name: 'ArbSys',
    description: 'Exposes a variety of system-level functionality for interacting with Ethereum and understanding the call stack.',
    deprecated: false,
    references: ['https://developer.arbitrum.io/for-devs/useful-addresses'],
  },
  {
  ...
  },
  {
    ...
    description: 'Allows registering and retrieving commonly used addresses via indices, saving calldata.',
    deprecated: false,
    references: ['https://developer.arbitrum.io/for-devs/useful-addresses'],
  },
  {
    ...
    name: 'ArbStatistics',
    description: 'Provides statistics about Arbitrum, such as the number of blocks, accounts, transactions, and contracts.',
    deprecated: false,
    references: ['https://developer.arbitrum.io/for-devs/useful-addresses'],
  },
  {
    ...
    name: 'NodeInterface',
    description: 'Retrieves the revenant data of calls by Arbitrum contracts to execute them in Ethereum via the Outbox contract.',
    deprecated: false,
    references: ['https://developer.arbitrum.io/for-devs/useful-addresses'],
  },
  {
  ...
  },
  {
    ...
    name: 'ArbAggregator',
    description: "Provides aggregators and their users methods for configuring how they participate in Ethereum aggregation. The default aggregator is Arbitrum's Sequencer.",
    deprecated: false,
    references: ['https://developer.arbitrum.io/for-devs/useful-addresses'],
  },
  {
    ...
    description: 'Allows aggregators to manage function tables for one form of transaction compression.',
    deprecated: false,
    references: ['https://developer.arbitrum.io/for-devs/useful-addresses'],
  },
  {
