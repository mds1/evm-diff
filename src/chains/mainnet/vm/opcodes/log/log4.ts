...
export const log4: Omit<Opcode, 'examples'> = {
  number: 0xa4,
  name: 'log4',
    ...
    variables: [
      {
        ...
        expression: '375 + 375 * topic_count',
        variables: [
          {
            name: 'topic_count',
  ...
  inputs: [
    ...
    {
      name: 'topic2',
      description: 'The 32-byte value of the second topic',
    },
    {
      name: 'topic3',
      description: 'The 32-byte value of the third topic',
    },
    {
      name: 'topic4',
      description: 'The 32-byte value of the fourth topic',
    },
  ],
  errorCases: [
    'Not enough gas',
